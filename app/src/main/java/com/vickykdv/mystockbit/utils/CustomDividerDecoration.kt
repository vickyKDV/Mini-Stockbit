...
class CustomDividerDecoration(context: Context, orientation: Int = VERTICAL, isShowInLastItem: Boolean = false, private val dividerAlpha:Int = 60) :
    ItemDecoration() {
